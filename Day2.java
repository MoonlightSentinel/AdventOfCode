public class Day2 {
	static int[][] myInput = { { 121, 59, 141, 21, 120, 67, 58, 49, 22, 46, 56, 112, 53, 111, 104, 130 },
	...
	public static void main(String... args) {
		int[][] test1 = { { 5, 1, 9, 5 }, { 7, 5, 3 }, { 2, 4, 6, 8 } };
		int[][] test2 = {
				{5,9,2,8},
				{9,4,7,3},
				{3,8,6,5}
		};
		System.out.println(check1(test1));
		System.out.println(check1(myInput));
		System.out.println("--------------");
		System.out.println(check2(test2));
		System.out.println(check2(myInput));
	}

	public static int check1(int[][] input) {
		int checksum = 0, min, max;
	...
	public static int check2(int[][] input) {
		int checksum = 0, a, b;
